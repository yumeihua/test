...
$databases = array (
  ...
  array (
    'default' =>
    array (
      'database' => 'd7_cc_www_acuvue_com_cn',
      'username' => 'root',
      'password' => 'bt3ynacqad',
      'host' => 'localhost',
      'port' => '',
 ...
 *
 */
$drupal_hash_salt = 'r8-tZ8hDyATKgkBqNKjs4YbGkYhd-eNCOR5NENEfNMY';
...
// $conf['cache_backends'][] = 'sites/www.acuvue.com.cn/modules/contrib/memcache/memcache.inc';
// $conf['cache_default_class'] = 'MemCacheDrupal';
// $conf['memcache_key_prefix'] = 'acuvue_china';
$conf['http_request_timeout'] = 10000;

$cn_forwarded_host = $_SERVER['HTTP_HOST'];
//Disable Shield authentication if it is not Edit domain
/*if (strpos($cn_forwarded_host, 'edit.mdd-apac') === FALSE) { 
    $conf['shield_user'] = NULL;
}*/
if (file_exists(__DIR__ . '/settings.platformsh.php') && !empty($_ENV['PLATFORM_PROJECT'])) {
